	...
	module.exports = new Class( {
		...
		, __removeConnection: function( connection ){
			...
			if ( debug ) log.debug( "[" + this.__connections.length + "] remaining, load is now [" + this.__loadFactor + "] ..." );
		...
		, __addConnection: function( connection  ){
			...
			this.__loadFactor = this.__connections.length / this.__weigth;
			if ( debug ) log.debug( "[" + this.__connections.length + "] connections on host, load is now [" + this.__loadFactor + "] ..." );
		}
	} );